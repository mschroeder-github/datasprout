...
public class ExcelCell {
    ...
    public String toString() {
        return "ExcelCell{" + "id=" + id + ", sheetId=" + sheetId + ", row=" + row + ", column=" + column + ", address=" + address + ", cellType=" + cellType + ", valueNumeric=" + valueNumeric + ", valueBoolean=" + valueBoolean + ", valueFormular=" + valueFormular + ", valueError=" + valueError + ", valueString=" + valueString + '}';
    }
    ...
    public String getValue() {
        ...
        if(cellType.equals("numeric")) {
            ...
            if(getValueRichText() != null) {
                return getValueRichText();
            }
