 ...
 * form.
 * @see <a href="https://github.com/mschroeder-github/rdf-to-rdb-rest-api">rdf-to-rdb-rest-api</a>
 */
 ...
 /*
    ...
    public class MultiCardinalityProperty {
        ...
        public String getName() {
            ...
            if(hasDomain()) {
                sb.append(SemanticUtility.getLocalName(getDomain().getURI())).append(" ");
            }
            
            sb.append(SemanticUtility.getLocalName(getProperty().getURI()));
            
            if(hasRange()) {
                sb.append(" ").append(SemanticUtility.getLocalName(getRange().getURI()));
            }
